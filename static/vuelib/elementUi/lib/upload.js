  ...
  methods: {
    ...
    handleSuccess: function handleSuccess(res, rawFile) {
      ...
      if (file) {
        ...
        this.onSuccess(res, file, this.uploadFiles, this.uploadName);
        this.onChange(file, this.uploadFiles);
      }
    },
    ...
    handleRemove: function handleRemove(file, raw) {
      ...
      var doRemove = function doRemove() {
        ...
        fileList.splice(fileList.indexOf(file), 1);
        _this2.onRemove(file, fileList, _this2.uploadName);
      };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_486ffe18_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_upload_list_vue__ = __webpack_require__(321);
var normalizeComponent = __webpack_require__(0)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_486ffe18_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_upload_list_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
