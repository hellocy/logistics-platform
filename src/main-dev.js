...
// axios 配置
axios.defaults.baseURL = 'http://lmp-test.com/' // dev
// axios.defaults.baseURL = 'http://lmp.hqygou.com/' // test
axios.defaults.baseURL = 'http://lmp.geek.io/' // dev

Vue.use(VueAxios, axios)

// 请求api
GLOBAL.hostUrl = 'http://lmp-test.com/' // dev
// GLOBAL.hostUrl = 'http://lmp.hqygou.com/' // dev
GLOBAL.hostUrl = 'http://lmp.geek.io/' // dev
